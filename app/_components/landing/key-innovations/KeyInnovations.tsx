    ...
    <section className="px-8 py-16 section-key-innovations">
      ...
      <div ref={rootRef} className="flex flex-row gap-8">
        <div>
          <div
            data-color="#f0d0c280"
            className="min-h-screen flex flex-col justify-center gap-4 flex-1 text-container"
          >
            ...
            <p className="text-xl">
              ...
              Broselow is trained on locally collected pediatric data, ensuring
              predictions are grounded in the real anthropometric
              characteristics of Ghanaian children. By learning from height,
              weight, age, and visual features specific to this population, the
              system delivers more accurate and context-appropriate estimates,
              reducing reliance on subjective visual judgment and improving
              clinical confidence during emergency care.
            </p>
          </div>
          <div
            data-color="#417fb980"
          ...
          >
            ...
            <p className="text-xl">
              In emergency and critical care situations, physically weighing or
              measuring a child can be unsafe, time-consuming, or simply
              impractical. Digital Broselow eliminates this challenge by
              providing rapid, non-contact height and weight estimation directly
              from images. This approach minimizes unnecessary handling, reduces
              stress for both patients and caregivers, and allows healthcare
              providers to act faster—supporting safer, more efficient emergency
          ...
          >
            ...
            <p className="text-xl">
              ...
              commonly used estimation tools when applied to Ghanaian children.
              These early findings demonstrate the model&apos;s potential to
              significantly reduce dosing errors linked to inaccurate weight
              estimation. While further validation is ongoing, the preliminary
              results provide strong evidence that Digital Broselow can evolve
              into a clinically reliable tool, capable of improving pediatric
              outcomes in real-world hospital and emergency settings.
            </p>
          </div>
        </div>
        {/** images here */}
